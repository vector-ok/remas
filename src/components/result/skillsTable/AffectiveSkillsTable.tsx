...
function AffectiveSkillsTable(): JSX.Element {
  ...
  useEffect(() => {
    const updateArray: UpdataedArrayType[] = [
      {
        trait: "Creativity",
        score: scores.creativityScore,
        grade:
          scores.creativityScore >= 0.8
            ? "A"
            : scores.creativityScore >= 0.6
            ? "B"
            : scores.creativityScore >= 0.5
            ? "C"
            : scores.creativityScore >= 0.4
            ? "D"
            : "E",
      },
      {
        trait: "Aesthetics Appreciation",
        score: scores.aestheticsAppreciationScore,
        grade:
          scores.aestheticsAppreciationScore >= 0.8
            ? "A"
            : scores.aestheticsAppreciationScore >= 0.6
            ? "B"
            : scores.aestheticsAppreciationScore >= 0.5
            ? "C"
            : scores.aestheticsAppreciationScore >= 0.4
            ? "D"
            : "E",
      },
      {
        trait: "Initiative",
        score: scores.initiativeSCore,
        grade:
          scores.initiativeSCore >= 0.8
            ? "A"
            : scores.initiativeSCore >= 0.6
            ? "B"
            : scores.initiativeSCore >= 0.5
            ? "C"
            : scores.initiativeSCore >= 0.4
            ? "D"
            : "E",
      },
      {
        trait: "Honesty",
        score: scores.honestyScore,
        grade:
          scores.honestyScore >= 0.8
            ? "A"
            : scores.honestyScore >= 0.6
            ? "B"
            : scores.honestyScore >= 0.5
            ? "C"
            : scores.honestyScore >= 0.4
            ? "D"
            : "E",
      },
      {
        ...
        grade:
          scores.leadershipScore >= 0.8
            ? "A"
            : scores.leadershipScore >= 0.6
            ? "B"
            : scores.leadershipScore >= 0.5
            ? "C"
            : scores.leadershipScore >= 0.4
            ? "D"
            : "E",
      },
    ]
...
export default AffectiveSkillsTable
